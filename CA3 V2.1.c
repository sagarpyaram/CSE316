...
main()
{
	...
	for(i=0;i<n;i++)
	{
		...
		{
			printf("Okay, lmao... You lil blind slut :)\n");
			getch();
			goto LBS;
		}
		AZ:
		...
		if(tri[i][1]<0)
		{
			printf("\nYou sick fuck. Arrival time cant be less than a fucking 0");
			getch();
			goto AZ;
		}
		BZ:
		...
		if(tri[i][2]<=0)
		{
			printf("\nYou THOT. Why the fuck is the burst time that. You retarded lil bitch.\nWhat kinda cheap pot you smokin'?'");
			getch();
			goto BZ;
		}
		tri[i][5]=0;
