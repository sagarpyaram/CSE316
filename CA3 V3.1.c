...
void *ThreadIntrob(void *vargp)
{
    ...
    printf("           |   |                                         |    |\n");
    printf("           |   |  C:\\ CSE316>                            |    |\n");
    printf("           |   |  C:\\ Run Simulation Based Project       |    |\n");
    printf("           |   |                                         |    |\n");
    printf("           |   |                                         |    |\n");
    printf("           |   |                                         |    |\n");
    printf("           |   |                                         |    |\n");
...
main()
{
	...
	system("color 0a");
	pthread_t tid; 
 	pthread_create(&tid, NULL, ThreadIntroa, NULL);      
	pthread_join(tid, NULL);
	Sleep(1000);
	//getch();
	system("cls");
	pthread_t tida; 
 	pthread_create(&tida, NULL, ThreadIntrob, NULL);      
	pthread_join(tida, NULL);
	Sleep(1000);
	//getch();
	system("cls");
	pthread_t tidb; 
 	pthread_create(&tidb, NULL, ThreadIntroc, NULL);      
